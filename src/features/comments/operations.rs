...
//!
//! All comment operation methods have been migrated to the main BlueprintEditorPanel
//! impl block in `src/editor/panel.rs`.
//!
//! ## Available Methods (implemented on BlueprintEditorPanel)
//!
...
//!
//! These methods are implemented as regular instance methods on BlueprintEditorPanel,
